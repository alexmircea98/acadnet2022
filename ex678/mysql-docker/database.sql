...
INSERT INTO entries (`date`, `user_id`, `message`) VALUES
    ...
    ("2022-05-05 12:05", 1, 'Here is one of our experts launching attacks on our enemies!<br />Flag{adv4nc3dsequeel}<br /><img src="/images/expert.jpg" width="800" />'),
...
--     (1, 'theflag', 'Flag{adv4nc3dsequeel}');
